...
char *french[LANG_STR_COUNT] = {
	...
	"Menu par dйfaut", // _STR_DEF_DEVICE
	...
	"Dйmarrage disque dur automatique", // _STR_AUTOSTARTHDD
	"Dйmarrer disque dur", // _STR_STARTHDD
...
char *polish[LANG_STR_COUNT] = {
	"               WITAMY W OPEN PS2 LOADER. GLУWNY KOD WZOROWANY NA KODZIE ZRУDLOWYM HD PROJECT <http://psx-scene.com> IMPLEMENTACJE FORMATU USB ADVANCE I GUI PRZEZ IFCARO <http://ps2dev.ifcaro.net> WIEKSZOSC JADRA LOADERA WYKONANA PRZEZ JIMMIKAELKAEL. WSZYSTKIE ULEPSZENIA GUI WYKONANE PRZEZ VOLCA. DZIEKUJEMY ZA SKORZYSTANIE Z NASZEJ APLIKACJI. ^^", // gfx.c:85
	"Open PS2 Loader %s", // gfx.c:320
	"Ustawienia skуrki", // gfx.c:502
