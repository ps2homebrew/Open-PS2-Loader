...
MISC_OBJS =	icon_sys_A.o icon_sys_J.o icon_sys_C.o conf_theme_OPL.o \
		scrollV.o scrollH.o page.o cancel.o transition.o alert.o confirm.o
...
$(EE_ASM_DIR)scrollV.s: misc/scrollV.adp | $(EE_ASM_DIR)
	$(BIN2S) $< $@ scrollV_adp

$(EE_ASM_DIR)scrollH.s: misc/scrollH.adp | $(EE_ASM_DIR)
	$(BIN2S) $< $@ scrollH_adp

$(EE_ASM_DIR)page.s: misc/page.adp | $(EE_ASM_DIR)
	$(BIN2S) $< $@ page_adp
...
$(EE_ASM_DIR)alert.s: misc/alert.adp | $(EE_ASM_DIR)
	$(BIN2S) $< $@ alert_adp
