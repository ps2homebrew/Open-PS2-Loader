...
struct UIItem diaNetConfig[] = {
    ...
    {UI_SPLITTER},
    {UI_LABEL, 0, 1, 1, -1, 0, 0, {.label = {NULL, _STR_SHOW_ADVANCED_OPTS}}},
    {UI_SPACER},
    {UI_SPACER},
    {UI_BOOL, NETCFG_SHOW_ADVANCED_OPTS, 1, 1, -1, -10, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_ETH_OPMODE}}},
    {UI_SPACER},
    ...
    // ---- IP address type ----
    {UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_IP_ADDRESS_TYPE}}},
    {UI_SPACER},
    {UI_ENUM, NETCFG_PS2_IP_ADDR_TYPE, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},

    // ---- IP address ----
    {UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_IP_ADDRESS}}},
    {UI_SPACER},
    ...
    //  ---- Netmask ----
    {UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_MASK}}},
    {UI_SPACER},
    ...
    //  ---- Gateway ----
    {UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_GATEWAY}}},
    {UI_SPACER},
    ...
    //  ---- DNS server ----
    {UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_DNS_SERVER}}},
    {UI_SPACER},
    ...
    {UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_ADDRESS_TYPE}}},
    {UI_SPACER},
    {UI_ENUM, NETCFG_SHARE_ADDR_TYPE, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},

    {UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_ADDRESS}}},
    {UI_SPACER},
    ...
    {UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_PORT}}},
    {UI_SPACER},
...
struct UIItem diaCompatConfig[] = {
    {UI_LABEL, 0, 1, 1, -1, 0, 0, {.label = {NULL, _STR_COMPAT_SETTINGS}}}, {UI_SPACER}, {UI_LABEL, COMPAT_GAME, 1, 1, -1, 0, 0, {.label = {"<Game Label>", -1}}},
...
struct UIItem diaUIConfig[] = {
    ...
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_THEME}}},
    {UI_SPACER},
    {UI_ENUM, UICFG_THEME, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_LANGUAGE}}},
    {UI_SPACER},
    {UI_ENUM, UICFG_LANG, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_SCROLLING}}},
    {UI_SPACER},
    {UI_ENUM, UICFG_SCROLL, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_AUTOSORT}}},
    {UI_SPACER},
    {UI_BOOL, UICFG_AUTOSORT, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_AUTOREFRESH}}},
    {UI_SPACER},
    {UI_BOOL, UICFG_AUTOREFRESH, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_COVERART}}},
    {UI_SPACER},
    {UI_BOOL, UICFG_COVERART, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_USE_INFO_SCREEN}}},
    {UI_SPACER},
    ...
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_VMODE}}},
    {UI_SPACER},
    {UI_ENUM, UICFG_VMODE, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_WIDE_SCREEN}}},
    {UI_SPACER},
...
struct UIItem diaCheatConfig[] = {
    ...
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_ENABLECHEAT}}},
    {UI_SPACER},
    {UI_BOOL, CHEATCFG_ENABLECHEAT, 1, 1, _STR_HINT_ENABLECHEAT, 0, 0, {.intvalue = {1, 1}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -45, 0, {.label = {NULL, _STR_CHEATMODE}}},
    {UI_SPACER},
...
struct UIItem diaAbout[] = {
    ...
    {UI_BREAK},
    {UI_SPACER},
    {UI_LABEL, 0, 1, 1, -1, 0, 15, {.label = {"izdubar - Jay-Jay - jimmikaelkael - misfire", -1}}},
    {UI_BREAK},
    {UI_SPACER},
...
struct UIItem diaNetCompatUpdate[] = {
    ...
    {UI_LABEL, NETUPD_OPT_UPD_ALL_LBL, 1, 1, -1, -20, 0, {.label = {NULL, _STR_NET_UPDATE_ALL}}},
    {UI_SPACER},
    {UI_BOOL, NETUPD_OPT_UPD_ALL, 0, 1, -1, 0, 0, {.intvalue = {0, 0, 0, 1}}},
    {UI_BREAK},
    {UI_BREAK},

    {UI_LABEL, NETUPD_PROGRESS_LBL, 1, 1, -1, -20, 0, {.label = {NULL, _STR_VMC_PROGRESS}}},
    {UI_SPACER},
