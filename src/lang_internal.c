...
char *internalEnglish[LANG_STR_COUNT] = {
    ...
    "Reduce read requests with cache",
    ...
    "Progress",
    "XVMC file exists.",
    "Invalid XVMC file, size is incorrect.",
    "XVMC file needs to be created.",
    "Error accessing XVMC %s. Continue without Memory Card?",
    "Automatic Refresh",
    "About",
    "Coders",
    "Quality Assurance",
    ...
    "XVMC %s file is fragmented. Continue without Memory Card?",
    "Audio Settings",
    "Sound Effects",
    "Boot Sound",
