...
struct UIItem diaConfig[] = {
    ...
    {UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {"ZSO Cache (BDM)", -1}}},
    {UI_SPACER},
    {UI_INT, CFG_BDMCACHE, 1, 1, -1, 0, 0, {.intvalue = {16, 16, 0, 32, NULL}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {"ZSO Cache (HDD)", -1}}},
    {UI_SPACER},
    {UI_INT, CFG_HDDCACHE, 1, 1, -1, 0, 0, {.intvalue = {0, 0, 0, 32, NULL}}},
    {UI_BREAK},
    {UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {"ZSO Cache (SMB)", -1}}},
    {UI_SPACER},
    {UI_INT, CFG_SMBCACHE, 1, 1, -1, 0, 0, {.intvalue = {4, 4, 0, 32, NULL}}},
    {UI_BREAK},
