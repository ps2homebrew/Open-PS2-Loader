...
struct UIItem diaConfig[] = {
	...
	{UI_LABEL, 0, 1, -1, {.label = {NULL, _STR_EXITTO}}}, {UI_SPACER}, {UI_STRING, CFG_EXITTO, 1, _STR_HINT_EXITPATH, {.stringvalue = {"", "", NULL}}}, {UI_BREAK},
	...
	{UI_LABEL, 0, 1, -1, {.label = {NULL, _STR_USB_PREFIX}}}, {UI_SPACER}, {UI_STRING, CFG_USBPREFIX, 1, -1, {.stringvalue = {"", "", NULL}}}, {UI_BREAK},
