...
static void PrepareGSM(char *cmdline) {
	...
	static const predef_vmode_struct predef_vmode[31] = {
		...
		{  VGA_VMODE, "VGA 640x480p @72Hz             ",	GS_NONINTERLACED,	GS_MODE_VGA_640_72, GS_FRAME,	(u64)make_display_magic_number(  479,	1279,	0,		1,		 18,	330),	0x0067800001C00009},
		{  VGA_VMODE, "VGA 640x480p @75Hz             ",	GS_NONINTERLACED,	GS_MODE_VGA_640_75, GS_FRAME, 	(u64)make_display_magic_number(  479,	1279,	0,		1,		 18,	360),	0x0067800001000001},
		{  VGA_VMODE, "VGA 640x480p @85Hz             ",	GS_NONINTERLACED,	GS_MODE_VGA_640_85, GS_FRAME,	(u64)make_display_magic_number(  479,	1279,	0,		1,		 18,	260),	0x0067800001000001},
		...
		{  VGA_VMODE, "VGA 800x600p @56Hz             ",	GS_NONINTERLACED,	GS_MODE_VGA_800_56, GS_FRAME,	(u64)make_display_magic_number(  599,	1599,	0,		1,		 25,	450),	0x0049600001600001},
		{  VGA_VMODE, "VGA 800x600p @60Hz             ",	GS_NONINTERLACED,	GS_MODE_VGA_800_60, GS_FRAME, 	(u64)make_display_magic_number(  599,	1599,	0,		1,		 25,	465),	0x0089600001700001},
		{  VGA_VMODE, "VGA 800x600p @72Hz             ",	GS_NONINTERLACED,	GS_MODE_VGA_800_72, GS_FRAME,	(u64)make_display_magic_number(  599,	1599,	0,		1,		 25,	465),	0x00C9600001700025},
		{  VGA_VMODE, "VGA 800x600p @75Hz             ",	GS_NONINTERLACED,	GS_MODE_VGA_800_75, GS_FRAME, 	(u64)make_display_magic_number(  599,	1599,	0,		1,		 25,	510),	0x0069600001500001},
		{  VGA_VMODE, "VGA 800x600p @85Hz             ",	GS_NONINTERLACED,	GS_MODE_VGA_800_85, GS_FRAME,	(u64)make_display_magic_number(  599,	1599,	0,		1,		 15,	500),	0x0069600001B00001},
		{  VGA_VMODE, "VGA 1024x768p @60Hz            ",	GS_NONINTERLACED,	GS_MODE_VGA_1024_60, GS_FRAME, 	(u64)make_display_magic_number(  767,	2047,	0,		2,		 30,	580),	0x00CC000001D00003},
		{  VGA_VMODE, "VGA 1024x768p @70Hz            ",	GS_NONINTERLACED,	GS_MODE_VGA_1024_70, GS_FRAME,	(u64)make_display_magic_number(  767,	1023,	0,		0,		 30,	266),	0x00CC000001D00003},
		{  VGA_VMODE, "VGA 1024x768p @75Hz            ",	GS_NONINTERLACED,	GS_MODE_VGA_1024_75, GS_FRAME, 	(u64)make_display_magic_number(  767,	1023,	0,		0,		 30,	260),	0x006C000001C00001},
		{  VGA_VMODE, "VGA 1024x768p @85Hz            ",	GS_NONINTERLACED,	GS_MODE_VGA_1024_85, GS_FRAME,	(u64)make_display_magic_number(  767,	1023,	0,		0,		 30,	290),	0x006C000002400001},
		{  VGA_VMODE, "VGA 1280x1024p @60Hz           ",	GS_NONINTERLACED,	GS_MODE_VGA_1280_60, GS_FRAME, 	(u64)make_display_magic_number(  1023,	1279,	1,		1,		 40,	350),	0x0070000002600001},
		{  VGA_VMODE, "VGA 1280x1024p @75Hz           ",	GS_NONINTERLACED,	GS_MODE_VGA_1280_75, GS_FRAME, 	(u64)make_display_magic_number(  1023,	1279,	1,		1,		 40,	350),	0x0070000002600001}
