...
static item_list_t hddGameList = {
    HDD_MODE, 0, 0, MODE_FLAG_COMPAT_DMA, MENU_MIN_INACTIVE_FRAMES, HDD_MODE_UPDATE_DELAY, NULL, NULL, &hddGetTextId, NULL, &hddGetPrefix, &hddInit, &hddNeedsUpdate, &hddUpdateGameList,
