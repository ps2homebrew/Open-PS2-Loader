...
struct UIItem diaConfig[] = {
	...
	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_EXITTO}}}, {UI_SPACER},
	...
	{UI_LABEL, CFG_LBL_AUTOSTARTLAST, 1, 1, -1, 0, 0, {.label = {NULL, _STR_AUTOSTARTLAST}}}, {UI_SPACER},
	{UI_INT, CFG_AUTOSTARTLAST, 1, 1, _STR_HINT_AUTOSTARTLAST, 0, 0, {.intvalue = {0, 0, 0, 9}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_SELECTBUTTON}}}, {UI_SPACER},
	{UI_ENUM, CFG_SELECTBUTTON, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
	{UI_SPLITTER},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_CHECKUSBFRAG}}}, {UI_SPACER},
	{UI_BOOL, CFG_CHECKUSBFRAG, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_USB_PREFIX}}}, {UI_SPACER},
	{UI_STRING, CFG_USBPREFIX, 1, 1, -1, 0, 0, {.stringvalue = {"", "", NULL}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_ETH_PREFIX}}}, {UI_SPACER},
	{UI_STRING, CFG_ETHPREFIX, 1, 1, -1, 0, 0, {.stringvalue = {"", "", NULL}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_HDD_SPINDOWN}}}, {UI_SPACER},
	{UI_INT, CFG_HDDSPINDOWN, 1, 1, _STR_HINT_SPINDOWN, 0, 0, {.intvalue = {20, 20, 0, 20}}},
	{UI_SPLITTER},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_USBMODE}}}, {UI_SPACER},
	{UI_ENUM, CFG_USBMODE, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_HDDMODE}}}, {UI_SPACER},
	{UI_ENUM, CFG_HDDMODE, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_ETHMODE}}}, {UI_SPACER},
	{UI_ENUM, CFG_ETHMODE, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_APPMODE}}}, {UI_SPACER},
...
struct UIItem diaUIConfig[] = {
	...
	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_TXTCOLOR}}}, {UI_SPACER},
	{UI_COLOUR, UICFG_TXTCOL, 1, 1, -1, 0, 0, {.colourvalue = {0, 0}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_SELCOLOR}}}, {UI_SPACER},
	{UI_COLOUR, UICFG_SELCOL, 1, 1, -1, 0, 0, {.colourvalue = {0, 0}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_UICOLOR}}}, {UI_SPACER},
	{UI_COLOUR, UICFG_UICOL, 1, 1, -1, 0, 0, {.colourvalue = {0, 0}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {NULL, _STR_BGCOLOR}}}, {UI_SPACER},
...
struct UIItem diaNetConfig[] = {
	...
	{UI_BUTTON, NETCFG_RECONNECT, 1, 1, -1, 0, 0, {.label = {NULL, _STR_RECONNECT}}}, {UI_BREAK},
...
struct UIItem diaNetCompatUpdate[] = {
	...
	{UI_BUTTON, NETUPD_BTN_CANCEL, 1, 1, -1, 0, 0, {.label = {NULL, _STR_CANCEL}}}, {UI_BREAK},
...
struct UIItem diaAbout[] = {
	...
	{UI_SPACER},
	{UI_LABEL, 0, 1, 1, -1, 0, 15, {.label = {"algol | Berion | danielB | El_Patas | EP | gledson999 | lee4", -1}}}, {UI_BREAK},
...
struct UIItem diaCompatConfig[] = {
	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_COMPAT_SETTINGS}}}, {UI_SPACER},
	{UI_LABEL, COMPAT_GAME, 1, 1, -1, 0, 0, {.label = {"<Game Label>", -1}}},
	{UI_SPLITTER},

	{UI_LABEL, COMPAT_STATUS, 1, 1, -1, 0, 0, {.label = {NULL, -1}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_MODE1}}}, {UI_SPACER},
	{UI_BOOL, COMPAT_MODE_BASE, 1, 1, _STR_HINT_MODE1, 0, 0, {.intvalue = {0, 0}}}, {UI_SPACER},
	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_MODE2}}}, {UI_SPACER},
	{UI_BOOL, COMPAT_MODE_BASE + 1, 1, 1, _STR_HINT_MODE2, 0, 0, {.intvalue = {0, 0}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_MODE3}}}, {UI_SPACER},
	{UI_BOOL, COMPAT_MODE_BASE + 2, 1, 1, _STR_HINT_MODE3, 0, 0, {.intvalue = {0, 0}}}, {UI_SPACER},
	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_MODE4}}}, {UI_SPACER},
	{UI_BOOL, COMPAT_MODE_BASE + 3, 1, 1, _STR_HINT_MODE4, 0, 0, {.intvalue = {0, 0}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_MODE5}}}, {UI_SPACER},
	{UI_BOOL, COMPAT_MODE_BASE + 4, 1, 1, _STR_HINT_MODE5, 0, 0, {.intvalue = {0, 0}}}, {UI_SPACER},
	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_MODE6}}}, {UI_SPACER},
	{UI_BOOL, COMPAT_MODE_BASE + 5, 1, 1, _STR_HINT_MODE6, 0, 0, {.intvalue = {0, 0}}}, {UI_BREAK},

	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_MODE7}}}, {UI_SPACER},
	{UI_BOOL, COMPAT_MODE_BASE + 6, 1, 1, _STR_HINT_MODE7, 0, 0, {.intvalue = {0, 0}}}, {UI_SPACER},
	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_MODE8}}}, {UI_SPACER},
...
// out of Childproof and Non-GSM builds. --Bat--
	...
	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_DMA_MODE}}}, {UI_SPACER},
...
#ifndef __CHILDPROOF
	{UI_BUTTON, COMPAT_VMC1_DEFINE, 1, 1, -1, 0, 0, {.label = {NULL, -1}}}, {UI_SPACER},
...
#ifndef __CHILDPROOF
	{UI_BUTTON, COMPAT_VMC2_DEFINE, 1, 1, -1, 0, 0, {.label = {NULL, -1}}}, {UI_SPACER},
	...
	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_GAME_ID}}}, {UI_SPACER},
	{UI_STRING, COMPAT_GAMEID, 1, 1, -1, 0, 0, {.stringvalue = {"", "", NULL}}}, {UI_SPACER},
	{UI_BUTTON, COMPAT_LOADFROMDISC, 1, 1, -1, 0, 0, {.label = {NULL, _STR_LOAD_FROM_DISC}}},
	{UI_SPLITTER},

	{UI_LABEL, 0, 1, 1, -1, -30, 0, {.label = {NULL, _STR_ALTSTARTUP}}}, {UI_SPACER},
	...
	{UI_BUTTON, COMPAT_DL_DEFAULTS, 1, 1, -1, 0, 0, {.label = {NULL, _STR_DL_DEFAULTS}}}, {UI_SPACER},
...
struct UIItem diaVMC[] = {
	...
	{UI_BUTTON, VMC_BUTTON_DELETE, 1, 1, -1, 0, 0, {.label = {NULL, _STR_DELETE}}}, {UI_BREAK},
